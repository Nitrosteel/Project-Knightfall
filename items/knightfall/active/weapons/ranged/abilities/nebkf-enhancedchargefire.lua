...
function NebKFEnhancedChargeFire:charge()
  ...
  while self.fireMode == (self.activatingFireMode or self.abilitySlot) and (self.chargeLevel and (self.chargeLevel.autoFire and self.chargeTimer < self.chargeLevel.time) or true) do
