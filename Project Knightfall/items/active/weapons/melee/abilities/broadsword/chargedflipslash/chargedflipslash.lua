...
NebsFlipSlash = WeaponAbility:new()

function NebsFlipSlash:init()
  self.cooldownTimer = self.cooldownTime
  self.chargeTimer = 0
  self.queryDamageSince = 0
end

function NebsFlipSlash:update(dt, fireMode, shiftHeld)
...
function NebsFlipSlash:flip(chargePercentage, fromJump)
